        ...
        },
        {
          ...
          value: function (e) {
            var i = this,
              ...
              r = !0;
            if (e.is('[data-abide-ignore]') || e.is('[type="hidden"]'))
              return !0;
            switch (e[0].type) {
              case 'radio':
          ...
          value: function () {
            ...
            (this.options.clickOpen || i) &&
              ...
              e.options.closeOnClickInside &&
                this.$menuItems.on(
                  'click.zf.dropdownmenu touchend.zf.dropdownmenu',
                  function (i) {
                    var s = t(this),
                      o = s.hasClass(n);
                    o || e._hide();
              ...
              this.$menuItems.on('keydown.zf.dropdownmenu', function (i) {
                ...
                a
                  ? e._isVertical()
                    ...
                    : Foundation.rtl()
                    ? t.extend(c, { next: u, previous: l, down: d, up: h })
      ...
      _createClass(e, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (
              (this._collapseTab(e), this._openTab(t), this.options.deepLink)
            ) {
          ...
          value: function (e) {
            ...
            if ((s.length && (n = 'tabs'), n !== e)) {
              ...
              if (
                ...
                d.length
                  ? ((u = t('<div class="tabs-content"></div>')
                      .insertAfter(d)
